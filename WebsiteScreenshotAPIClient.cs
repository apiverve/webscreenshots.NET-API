...
namespace APIVerve
{
    public class WebsiteScreenshotAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/webscreenshots";
        ...
        public WebsiteScreenshotAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public WebsiteScreenshotAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WebsiteScreenshotQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(WebsiteScreenshotQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(WebsiteScreenshotQueryOptions options)
        {
